package com.example.gsmgogoapi.global.security.jwt;

import com.example.gsmgogoapi.global.exception.error.ExpectedException;
import com.example.gsmgogoapi.global.manager.CookieManager;
import com.example.gsmgogoapi.global.security.jwt.dto.TokenResponse;
import com.example.gsmgogoapi.global.security.principle.AuthDetailsService;
...
public class JwtTokenProvider {
    ...
    private Claims getTokenBody(String token) {
        try {
            ...
            throw new ExpectedException("올바르지 않은 토큰입니다.", HttpStatus.UNAUTHORIZED);
        }
    }
}
